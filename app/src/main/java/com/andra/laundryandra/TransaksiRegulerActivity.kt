...
class TransaksiRegulerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.transaksi_reguler) // Gunakan layout XML yang sudah ada
    ...
    private fun simpanDataTransaksi(tanggal: String) {
        ...
        val transaksi = mapOf(
            ...
            "jumlah" to jumlahInt,
            "layanan" to "Reguler", // Gunakan "Express" sesuai gambar
            "total" to formatRupiah, // Format total harga
            "Tanggal" to tanggal // Gunakan "Tanggal" dengan huruf besar
        )
